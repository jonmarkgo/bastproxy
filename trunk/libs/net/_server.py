...
from mccp import MCCP2, MCCP2_CLIENT
from gmcp import GMCP, GMCP_CLIENT
...
class Proxy(Telnet):
  def __init__(self, host, port):
    ...
    self.clients = []
    self.ttype = 'Server'
    self.option_handlers[ord(MCCP2)] = MCCP2_CLIENT(self)
    self.option_handlers[ord(GMCP)] = GMCP_SERVER(self)
